...
import hs.project.calendarcustom.databinding.ActivityCustomBinding
...
class CustomActivity : AppCompatActivity() {
    ...
    private fun setUpAdapter() {
        ...
        adapter = CalendarAdapter { calendarDateModel: CalendarDateModel, position: Int ->
            calendarList2.forEachIndexed { index, calendarDateModel ->
                calendarDateModel.isSelected = index == position
            }
